...
def open():
    filename = filedialog.askopenfilename(initialdir="G:\Documents\testFichier", title="Select a File", filetypes=(("mov files", "*.mov"),("all files", "*.*")))

# Bouton Watchfolder
watchfolder = Label(fenetre, text="Watchfolder")
watchfolder.place(x=48, y=510)
bouton_1=Button(fenetre, text="Choisir ...", command=open(), bg="grey")
